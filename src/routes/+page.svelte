...
<div class="border padding-large">
    ...
    <button on:click={()=>{goto(`/leaveform/addrecord?id=${record.id}`)}} class="btn-success" style="padding:0.2em;">
    ...
    <button on:click={()=>{goto(`/leaveform?employeeid=${record.id}`)}} class="btn-secondary" style="padding:0.2em;">
		<svg class="svg-icon" viewBox="0 0 20 20">
