...
<div>
  <h4>  
    ...
    {#if currEmployee}
      <LeavebalanceComponent employee_id={currEmployee.id}/>
    {/if}
    <EmployeeComponent let:currRecord={record}>    
    <Popover label="Veiw Balance" position="left">    
      <button on:click={()=>{currEmployee=record}} class='btn-secondary' style="padding:0.2em;"><svg class="svg-icon" viewBox="0 0 20 20">
    ...
    <Popover label="Edit Balance" position="top">     
      <button on:click={()=>{currEmployee=record}} class='btn-success' style="padding:0.2em;"><svg class="svg-icon" viewBox="0 0 20 20">
